...
@esw_app.post("/esw/populate_episode_tfidf_topics/", tags=['ES Writer'])
def populate_episode_tfidf_topics(show_key: ShowKey, episode_key: str, topic_grouping: str, simple_episode_topics: list):
    '''
...
def populate_episode_topic_tfidf_scores(show_key: ShowKey, topic_grouping: str, model_vendor: str, model_version: str):
    ...
    for e_key, t_keys_to_scores in ekey_tkey_scores.items():
        ...
        if topic_grouping in ['universalGenres'] and model_vendor == 'openai' and model_version == '3small':
            ...
            simple_episode_topics = fflat.flatten_es_topics(tfidf_sorted_episode_topics)
            populate_episode_tfidf_topics(show_key, e_key, topic_grouping, simple_episode_topics)
