...
# from elasticsearch_dsl import Document, Date, Nested, InnerDoc, Keyword, Text, Integer, analyzer, TokenCount, DenseVector, Object, Float, Boolean
from opensearch_dsl import Document, Date, Nested, InnerDoc, Keyword, Text, Integer, analyzer, TokenCount, Object, Float, Boolean
# from opensearchpy import DenseVector
...
# class EsEpisodeTranscriptEmbeddings(Document):
#     show_key = Keyword()
#     episode_key = Keyword()
#     indexed_ts = Date()
#     # embeddings per model
