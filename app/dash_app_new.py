...
# from app.pages import character_listing, episode, series, oopsy
...
#     utils.hilite_in_logs(f'NEW PAGE LOAD ts={display_page_start_ts} pathname={pathname} parsed_dict={parsed_dict}')
...
#         utils.hilite_in_logs(f'invoke episode_palette.generate_content at ts={display_page_end_ts} duration={display_page_duration}')

#         return episode.generate_content(show_key, episode_key, all_seasons, episode_dropdown_options, emotion_dropdown_options)
...
#         display_page_end_ts = dt.now()
#         display_page_duration = display_page_end_ts - display_page_start_ts
#         utils.hilite_in_logs(f'invoke series_palette.generate_content at ts={display_page_end_ts} duration={display_page_duration}')

#         return series.generate_content(show_key, all_seasons, series_summary, all_season_dicts, speaker_color_map, universal_genres_parent_topics)
...
#         display_page_end_ts = dt.now()
#         display_page_duration = display_page_end_ts - display_page_start_ts
#         utils.hilite_in_logs(f'invoke character_listing_palette.generate_content at ts={display_page_end_ts} duration={display_page_duration}')

#         return character_listing.generate_content(show_key, all_seasons, series_summary)
...
#     callback_start_ts = dt.now()
#     utils.hilite_in_logs(f'callback invoked: render_series_topic_figs ts={callback_start_ts} show_key={show_key} topic_grouping={topic_grouping} score_type={score_type}')
...
#     callback_end_ts = dt.now()
#     display_page_duration = callback_end_ts - callback_start_ts
#     utils.hilite_in_logs(f'render_series_topic_figs returned at ts={callback_end_ts} duration={display_page_duration}')
