...
def render_bertopic_model_clusters(show_key: str, bertopic_model_id: str):
    ...
    # NOTE disabling these in prep for AWS deployment, BERTopic lib dependencies are too massive
    ...
    return bertopic_model_clusters_scatter, bertopic_model_clusters_dt, bertopic_model_id
