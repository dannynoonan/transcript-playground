...
def render_character_summary(show_key: str, speaker_key: str):
    ...
    if 'speaker' not in speaker_es_response:
        ...
        print(err_msg)
    summary = f'{speaker_key} character page'
    ...
    return summary, alt_names, actor_names, season_count, episode_count, scene_count, line_count, word_count, top_mbti, top_dnda
