...
def main():
    ...
    doc_ids_response = esr.fetch_doc_ids(ShowKey(show_key), user_dependency)
    ...
    for doc_id in doc_ids:
        ...
        narrative_sequences_response = esw.populate_episode_narratives(ShowKey(show_key), episode_key, user_dependency)
